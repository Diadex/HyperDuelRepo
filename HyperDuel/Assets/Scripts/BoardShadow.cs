...
public class BoardShadow : Board
{
    ...
    int nextIndex = 0;
    void Start() {
        pathFinder = new ShortestPathFinder( boardPlacement);
        ...
        adj = pathFinder.getMapConnections(adj);
    }
    ...
    private Queue<Pebble> ShortestPebblePath(Pebble startPebble, Pebble endPebble) 
    {
        ...
        Queue<int> path = pathFinder.getShortestDistance( adj, source, dest, v, boardPlacement);
